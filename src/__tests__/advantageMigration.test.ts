  ...
  const mockAdvantageDefs: IAdvantageDef[] = [
    {
      ...
      ranked: true,
      maxRank: null,
      description: 'Test advantage with subtype',
      longDescription: 'Test advantage with subtype requirement',
    ...
    },
    {
      ...
      ranked: false,
      maxRank: null,
      description: 'Test advantage without subtype',
      longDescription: 'Test advantage without subtype requirement',
